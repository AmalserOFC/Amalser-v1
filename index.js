...
apiku = 'https://t.me/movieuploaders_link/'
gc_wa_lu = 'https://chat.whatsapp.com/IyNsgCEOhZ9EpMALYchJ0l' //klo gk punya gc wa gk usah di ganti 👍
...
let papakpo = [{
								...
								sendButLocation(from, userProcfile , `NOTE ！\nJika whatsapp mod kamu belum support button silahkan tonton video ini https://youtu.be/eV5ClCGtyRg\n\n© ${ownername}`,pp_userz, papakpo, {contextInfo: { mentionedJid: [sender]}})
}
break
...
await limitAdd(sender, limit)
		...
		if (!isQuotedSticker) return reply('```Reply stc nya```')
		            ...
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `AMALSER OFC`
			...
			case 'sticker': case 'stikerin':
				case 'stiker': case 's':{
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							exif.create('Created By', 'AmalserOfc', `stickwm_${sender}`)
							//ran = getRandom('.webp')
                        await ffmpeg(`./${media}`)
                            .input(media)
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Bot by Amalser 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
...
case 'tahta':  
                   ...
                   tahtah = `${lang.success()}\n\nPlease Subscribe https://youtu.be/eV5ClCGtyRg`
...
if (budy.includes("eror",'error','Eror','Error')){
					...
					alpha.sendMessage(from, daieeeee, sticker, { contextInfo: {mentionedJid: [sender]}, quoted: { "key": { "participant": `${numbernye}@s.whatsapp.net`, "remoteJid":  '6283136505591-1614953337@g.us', "fromMe": false, "id": "B391837A58338BA8186C47E51FFDFD4A" }, "message": { "documentMessage": { "jpegThumbnail": fs.readFileSync(`image/${thumbnail}`), "mimetype": "application/octet-stream","title": "YT : Amalser OFC", "fileLength": "36", "pageCount": 0, "fileName": `Kenapa bisa error???`}}, "messageTimestamp": "1614069378", "status": "PENDING"}})
		        }
